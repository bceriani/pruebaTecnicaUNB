                    ...
                    <div class="relative flex flex-col min-w-0 rounded break-words border bg-gray-800 border-1 border-gray-300 bg-gray-800 text-white" style="border-radius: 1rem;">
                        <div class="flex-auto p-6 p-12 text-center">
                            ...
                            <div class="md:mb-12 md:mt-6 pb-5">
                                ...
                                <h2 class="font-bold text-2xl mb-2 uppercase">Registrarse</h2>
                                ...
                                <form action="/register" method="POST">
                                    ...
                                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" value="Registrarse" type="submit">Registrarse</button>
                            ...
                            <div>
                                <p class="mb-0">Ya tiene una cuenta?
                                <a class="text-white-50 fw-bold" href="/login">Inicia Sesion</a>
                                </p>
                            </div>
